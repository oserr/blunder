...
TEST(MoveWhitePawnsSingle, OneSquareForward)
{
  ...
  EXPECT_THAT(MoveWhitePawnsSingle(pawns, ~BitBoard()), EqualToSq(moves));
}
...
TEST(MoveWhitePawnsDouble, TwoSquaresForward)
{
  ...
  EXPECT_THAT(MoveWhitePawnsDouble(pawns, ~BitBoard()), EqualToSq(moves));
}
...
TEST(MoveWhitePawnsAttackLeft, AttackLeft)
{
  ...
  EXPECT_THAT(MoveWhitePawnsAttackLeft(pawns, ~BitBoard()), EqualToSq(moves));
}
...
TEST(MoveWhitePawnsAttackRight, AttackRight)
{
  ...
  EXPECT_THAT(MoveWhitePawnsAttackRight(pawns, ~BitBoard()), EqualToSq(moves));
}
...
TEST(MoveBlackPawnsSingle, OneSquareForward)
{
  ...
  EXPECT_THAT(MoveBlackPawnsSingle(pawns, ~BitBoard()), EqualToSq(moves));
}
...
TEST(MoveBlackPawnsDouble, TwoSquaresForward)
{
  ...
  EXPECT_THAT(MoveBlackPawnsDouble(pawns, ~BitBoard()), EqualToSq(moves));
}
...
TEST(MoveBlackPawnsAttackLeft, AttackLeft)
{
  ...
  EXPECT_THAT(MoveBlackPawnsAttackLeft(pawns, ~BitBoard()), EqualToSq(moves));
}
...
TEST(MoveBlackPawnsAttackRight, AttackRight)
{
  ...
  EXPECT_THAT(MoveBlackPawnsAttackRight(pawns, ~BitBoard()), EqualToSq(moves));
}
